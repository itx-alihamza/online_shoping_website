import { filterCollectionArray } from "@/app/utils/filtersShopPage";
import React, { useState } from "react";

const FilterCollectionDropDown = () => {
  ...
  return (
    <div className=" max-w-[90%] flex flex-col  gap-y-4">
      <div className="flex flex-row justify-between items-center">
        <p className="text-sm font-math font-bold">Collections</p>
        <img
      ...
      >
        {filterCollectionArray.map((item) => {
          return (
...
export default FilterCollectionDropDown;
